...
func main() {
	...
	fmt.Println(
		"Um número aleatorio será sorteado. Tente acertar. O número inteiro entre 0 e 100",
	)
	...
	for i := range chutes {
		...
		switch {
		case chuteInt < x:
			fmt.Println("O número sorteado é maior que", chuteInt)
		case chuteInt > x:
			fmt.Println("O número sorteado é menor que", chuteInt)
		case chuteInt == x:
			fmt.Printf(
